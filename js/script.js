...
const hookahsUnsorted = [
	...
	for (let i = 0; i < hookahsUnsorted.length; i++) {
		if (yahya.checked === true && hookahsUnsorted[i].firm == 'Yahya') {
			 
				 hookahs.push(hookahsUnsorted[i])
				
			}
		
		if (palka.checked === true && hookahsUnsorted[i].firm == 'Palka') {
		...
		if (abarid.checked === true && hookahsUnsorted[i].firm == 'Abarid') {
		...
		if (other.checked === true && hookahsUnsorted[i].firm == 'Other') {
				hookahs.push(hookahsUnsorted[i])
			}
		else {
